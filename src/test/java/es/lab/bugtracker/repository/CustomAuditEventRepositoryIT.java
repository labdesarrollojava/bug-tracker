package es.lab.bugtracker.repository;

import es.lab.bugtracker.BugtrackerApp;
import es.lab.bugtracker.config.Constants;
import es.lab.bugtracker.config.audit.AuditEventConverter;
import es.lab.bugtracker.domain.PersistentAuditEvent;
...
import static es.lab.bugtracker.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
